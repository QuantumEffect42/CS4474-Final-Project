...
import { questions } from "./questions/BPlusHardQuestions";
import Magnifier from "react-magnifier";
import avlImage from "./images/BplusTree.png"
...
export default class BPlusQuizHard extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            resultText: "",
    ...
    next = () =>{
        ...
        if(questionIndex === this.state.numberOfQuestions - 1){ //add the finsih button if we are at the last question in the set
    ...
    render(){
        ...
        if(finishedQuiz){
            ...
            finshButton = <Link to={"/BPlusQuizFinished"} state={{from: scoreText}} style={linkStyle}>Finish Quiz</Link>
        }
        else{
            finshButton = <></>
        }
                ...
                <div className="Page-Container">
                    ...
                    <div className="panel">
                        ...
                        <div className="img-magnifier-container">
                            <Magnifier src={avlImage} width={400} height={400}/>
                        </div>
                    </div>
