...
import { questions } from "./questions/BPlusQuestions";
import "./Quiz-Style.css";
import Magnifier from "react-magnifier";
import bPlusImage from "./images/BplusTree.png"
import { Link } from "react-router-dom";

var questionIndex = 0;
var scoreArray;

export default class BPlusQuiz extends React.Component{
    ...
    render(){
        ...
        const finsihedQuiz = this.state.finishedQuiz;
        let answerSum = 0;
        let finshButton;
        if(finsihedQuiz){
                ...
                <div className="Page-Container">
                    ...
                    <div className="panel">
                        ...
                        <div className="img-magnifier-container">
                            <Magnifier src={bPlusImage} zoomFactor={1.1} height={380} width={400}/>
                        </div>
                    </div>
