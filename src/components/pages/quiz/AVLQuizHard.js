...
import { questions } from "./questions/AVLHardQuestions";
...
export default class AVLQuizHard extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            resultText: "",
    ...
    render(){
        ...
        if(finishedQuiz){
            ...
            finshButton = <Link to={"/AVLQuizFinished"} state={{from: scoreText}} style={linkStyle}>Finish Quiz</Link>
        }
        else{
            finshButton = <></>
        }
